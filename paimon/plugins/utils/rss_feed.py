...
from paimon import Config, Message, get_collection, logging, paimon, pool
...
"""
    ...
    if thumb:
        args = {
            "caption": out_str,
            "parse_mode": "md",
            "reply_markup": markup if paimon.has_bot else None,
        }
    else:
        args = {
            "text": out_str,
    ...
    for chat_id in RSS_CHAT_ID:
        ...
        try:
            await send_rss_to_telegram(paimon.bot, args, thumb)
        except (
            ChatWriteForbidden,
            ChannelPrivate,
            ChatIdInvalid,
            ...
            if "caption" in args:
                ...
                args["text"] = out_str
            await send_rss_to_telegram(paimon, args, thumb)
