...
# Suggested by - @d0n0t (https://github.com/code-rgb/paimon/issues/9)
...
from paimon.utils import post_to_telegraph, runcmd, safe_filename


@paimon.on_cmd("mediainfo", about={"header": "Get Detailed Info About Replied Media"})
