...
@paimon.on_cmd("clock$", about={"header": "kensar clock animation"})
...
@paimon.on_cmd("emoji$", about={"header": "Multiple Animated Emojis"})
...
@paimon.on_cmd("bigoof$", about={"header": "Use when something is beyond just oof"})
...
@paimon.on_cmd("earth$", about={"header": "Beautiful Earth Animation"})
...
@paimon.on_cmd("brain$", about={"header": "Dump your Brain into Trash"})
...
@paimon.on_cmd("hack$", about={"header": "kensar hacking animation"})
...
@paimon.on_cmd("kill$", about={"header": "Kill anybody With Full Power ;-)"})
