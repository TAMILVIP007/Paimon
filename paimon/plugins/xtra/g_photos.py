...
TOKEN_FILE_NAME = os.path.join(Config.DOWN_PATH, "gPhoto_credentials_paimon.json")
...
@paimon.on_cmd("gpsetup", about={"header": "setup gphotos"})
...
async def create_token_file():
    ...
    async with paimon.conversation(Config.LOG_CHANNEL_ID, timeout=150) as conv:
