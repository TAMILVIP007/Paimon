...
PATH = "./paimon/xcache/ytsearch.json"
...
async def iytdl_inline(message: Message):
    ...
    if message.client.is_bot:
        ...
        x = await paimon.get_inline_bot_results(bot.username, f"ytdl {input_url}")
        await message.delete()
...
if paimon.has_bot:
    ...
    async def ytdl_download_callback(c_q: CallbackQuery):
        ...
        upload_msg = await paimon.send_message(Config.LOG_CHANNEL_ID, "Uploading...")
        ...
        refresh_vid = await paimon.bot.get_messages(
