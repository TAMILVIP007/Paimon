...
import paimon  # pylint: disable=unused-import

_LOG = paimon.logging.getLogger(__name__)
...
class RawClient(Client):
    ...
    def __init__(self, bot: Optional['paimon.core.client.paimonBot'] = None, **kwargs) -> None:
        self._bot = bot
        super().__init__(**kwargs)
        self._channel = paimon.core.types.new.ChannelLogger(self, "CORE")
        paimon.core.types.new.Conversation.init(self)
