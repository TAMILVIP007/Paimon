...
from paimon.utils import SafeDict, get_file_id, parse_buttons, rand_array
...
class ChannelLogger:
    """ Channel logger for paimon """
    def __init__(self, client: Union['_client.paimon', '_client.paimonBot'], name: str) -> None:
    ...
    async def forward_stored(self,
        ...
        Parameters:
            client (`paimon` | `paimonBot`):
                Pass paimon or paimonBot.
